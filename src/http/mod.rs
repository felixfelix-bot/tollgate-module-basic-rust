...
pub fn create_router(state: AppState) -> Router {
    ...
    Router::new()
        .route("/", axum::routing::get(routes::discovery::handle_discovery).post(routes::pay::handle_pay))
        .route("/whoami", axum::routing::get(routes::whoami::handle_whoami))
        .route("/usage", axum::routing::get(routes::usage::handle_usage))
        .route("/balance", axum::routing::get(routes::balance::handle_balance))
        .route("/ln-invoice", axum::routing::post(routes::ln_invoice::handle_create_ln_invoice)
